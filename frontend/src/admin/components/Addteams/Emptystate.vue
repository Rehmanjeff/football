<template>
  <div class="mt-8 mb-8 text-center">
    ...
    <h3 class="mt-2 text-sm font-semibold text-gray-900">No players</h3>
    <p class="mt-1 text-sm text-gray-500"> 
      Get started by creating a new player.
    </p>
    <div class="mt-6"> 
      <button   @click="$emit('buttonClick')"   type="button"   class="inline-flex items-center px-3 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600" >   <PlusIcon class="-ml-0.5 mr-1.5 h-5 w-5" aria-hidden="true" />
        Add Players
      </button>
    </div>
  </div>
